...
class CustomGoogleApis extends NetworkFirst {
    constructor(options) {
        super(options);
    ...
    async _handle(request, handler) {
        const callbackNumber = request.url.split("fcb")[1];
        handler.destroy();
        return new Response(
            `
        ...
        */
        ...
        gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
                ...
                try {
                    if (e && 0 < e.length) {
                        ...
                        for (c = {}; b < e.length; ) {
                            ...
                            d = void 0;
                            f = typeof n;
                            d = "object" == f && null != n || "function" == f ? "o" + (Object.prototype.hasOwnProperty.call(n, h) && n[h] || (n[h] = ++aa)) : (typeof n).charAt(0) + n;
                            Object.prototype.hasOwnProperty.call(c, d) || (c[d] = !0,
                            e[a++] = n)
                        }
                        e.length = a;
                        p = p + "?le=" + e.join(",")
            ...
            var V = decodeURI("%73cript"), W = /^[-+_0-9\\/A-Za-z]+={0,2}$/, X = function(a, b) {
                ...
                var a = D.nonce;
                return void 0 !== a ? a && a === String(a) && a.match(W) ? a : D.nonce = null : t.querySelector ? (a = t.querySelector("script[nonce]")) ? (a = a.nonce || a.getAttribute("nonce") || "",
                a && a === String(a) && a.match(W) ? D.nonce = a : D.nonce = null) : null : null
            }, wa = function(a) {
        ...
        gapi.load("", {
            callback: window["__iframefcb${callbackNumber}"],
            _c: {
                "jsl": {
                    "ci": {
                        "deviceType": "mobile",
                    ...
                    "u": "https://apis.google.com/js/api.js?onload\u003d__iframefcb${callbackNumber}",
                    "hee": true,
                    "dpo": false,
                    "le": []
                },
...
registerRoute(
    ({ url }) => url.href.includes("https://apis.google.com/js/api.js?") === true,
    new CustomGoogleApis({
        cacheName: "tcv-google-apis",
        plugins: [
