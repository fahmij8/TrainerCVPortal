...
(c) 2020 Adam Shaw
*/
export let FullCalendar = (function (e) {
    "use strict";
    var t = function (e, n) {
        return (t =
    ...
    function N(e, t, n, r, o, i, a, s) {
        ...
        if (null === t.type) v === g || (s && e.data === g) || (e.data = g);
            ...
            (function (e, t, n, r, o) {
                ...
                s || ("value" in g && void 0 !== (l = g.value) && (l !== e.value || ("progress" === t.type && !l)) && k(e, "value", l, v.value, !1), "checked" in g && void 0 !== (l = g.checked) && l !== e.checked && k(e, "checked", l, v.checked, !1));
        }
        return e;
    }
    function H(e, t, n) {
            ...
            (e.prototype.updateData = function () {
                ...
                if (m && m !== y)
                    for (var E in (m.timeZone !== y.timeZone &&
                        ((d.eventSources = v.eventSources = ((a = v.eventSources), (s = d.dateProfile), (l = v), (u = s ? s.activeRange : null), Po(a, Ho(a, l), u, !0, l))),
    ...
    var na = (function (e) {
        ...
        return (
            ...
            (t.prototype.render = function () {
                ...
                var h = !pr();
                return Ar("table", { className: s.join(" "), style: { height: e.height } }, Boolean(!h && d.length) && Ar.apply(void 0, o(["thead", {}], d)), Boolean(!h && p.length) && Ar.apply(void 0, o(["tbody", {}], p)), Boolean(!h && f.length) && Ar.apply(void 0, o(["tfoot", {}], f)), h && Ar.apply(void 0, o(["tbody", {}], d, p, f)));
            }),
            (t.prototype.renderSection = function (e, t) {
            ...
            (t.prototype.renderChunkTd = function (e, t, n) {
                ...
                var r = this.props,
                    ...
                    d = e.key,
                    p = qi(e, n, { tableColGroupNode: t, tableMinWidth: "", clientWidth: r.collapsibleWidth || void 0 === a[d] ? null : a[d], clientHeight: void 0 !== s[d] ? s[d] : null, expandRows: e.expandRows, syncRowHeights: !1, rowSyncHeights: [], reportRowHeightChange: function () {} });
                        ...
                        if (e) {
                            ...
                            i === a || (p.editable && p.droppable)
                                ? (s = (function (e, t, n) {
                                      ...
                                      return u;
                                  })(r, e, a.getCurrentData().pluginHooks.eventDragMutationMassagers)) && ((l = Hn(n, a.getCurrentData().eventUiBases, s, a)), (c.mutatedEvents = l), d.isInteractionValid(c) || ((u = !0), (s = null), (l = null), (c.mutatedEvents = { defs: {}, instances: {} })))
                                : (a = null);
                        }
                ...
                (t.prototype.renderSimpleLayout = function (e, t) {
                    ...
                    return (
                        ...
                        Ar(Do, { viewSpec: r.viewSpec }, function (e, t) {
                            return Ar("div", { ref: e, className: ["fc-daygrid"].concat(t).join(" ") }, Ar(na, { liquid: !n.isHeightAuto && !n.forPrint, collapsibleWidth: n.forPrint, cols: [], sections: o }));
                        })
                    );
                }),
                (t.prototype.renderHScrollLayout = function (e, t, n, r) {
                    ...
                    return (
                        ...
                        Ar(Do, { viewSpec: a.viewSpec }, function (e, t) {
                            return Ar("div", { ref: e, className: ["fc-daygrid"].concat(t).join(" ") }, Ar(o, { liquid: !i.isHeightAuto && !i.forPrint, collapsibleWidth: i.forPrint, colGroups: [{ cols: [{ span: n, minWidth: r }] }], sections: u }));
                        })
                    );
                }),
                t
            ...
            return (
                ...
                (t.prototype.render = function () {
                    ...
                    return (
                        ...
                        Ar(
                            "div",
                            { className: ["fc-daygrid-body", g ? "fc-daygrid-body-balanced" : "fc-daygrid-body-unbalanced", a ? "" : "fc-daygrid-body-natural"].join(" "), ref: this.handleRootEl, style: { width: t.clientWidth, minWidth: t.tableMinWidth } },
            ...
            return (
                ...
                (t.prototype.renderSimpleLayout = function (e, t, n) {
                    ...
                    return (
                        ...
                        t && (i.push({ type: "body", key: "all-day", chunk: { content: t } }), i.push({ type: "body", key: "all-day-divider", outerContent: Ar("tr", { className: "fc-scrollgrid-section" }, Ar("td", { className: "fc-timegrid-divider " + r.theme.getClass("tableCellShaded") })) })),
                        ...
                        Ar(Do, { viewSpec: r.viewSpec, elRef: this.rootElRef }, function (e, t) {
                            return Ar("div", { className: ["fc-timegrid"].concat(t).join(" "), ref: e }, Ar(na, { liquid: !o.isHeightAuto && !o.forPrint, collapsibleWidth: o.forPrint, cols: [{ width: "shrink" }], sections: i }));
                        })
                    );
                }),
                (t.prototype.renderHScrollLayout = function (e, t, n, r, o, i, a) {
                    ...
                    return (
                        ...
                        Ar(Do, { viewSpec: u.viewSpec, elRef: this.rootElRef }, function (e, t) {
                            return Ar("div", { className: ["fc-timegrid"].concat(t).join(" "), ref: e }, Ar(l, { liquid: !c.isHeightAuto && !c.forPrint, collapsibleWidth: !1, colGroups: [{ width: "shrink", cols: [{ width: "shrink" }] }, { cols: [{ span: r, minWidth: o }] }], sections: f }));
                        })
                    );
                }),
            ...
            return (
                ...
                (t.prototype.render = function () {
                    ...
                    return Ar(ca, { elRef: t.elRef, date: t.date, dateProfile: t.dateProfile, todayRange: t.todayRange, extraHookProps: t.extraHookProps }, function (a, s, l) {
                        return Ar("td", r({ ref: a, className: ["fc-timegrid-col"].concat(s, t.extraClassNames || []).join(" ") }, l, t.extraDataAttrs), Ar("div", { className: "fc-timegrid-col-frame" }, Ar("div", { className: "fc-timegrid-col-bg" }, e.renderFillSegs(t.businessHourSegs, "non-business"), e.renderFillSegs(t.bgEventSegs, "bg-event"), e.renderFillSegs(t.dateSelectionSegs, "highlight")), Ar("div", { className: "fc-timegrid-col-events" }, e.renderFgSegs(t.fgEventSegs, i)), Ar("div", { className: "fc-timegrid-col-events" }, e.renderFgSegs(o, {}, Boolean(t.eventDrag), Boolean(t.eventResize), Boolean(n))), Ar("div", { className: "fc-timegrid-now-indicator-container" }, e.renderNowIndicator(t.nowIndicatorSegs)), Ar(Vs, { date: t.date, dateProfile: t.dateProfile, todayRange: t.todayRange, extraHookProps: t.extraHookProps })));
                    });
                }),
        ...
        return (
            ...
            (t.prototype.eventRangeToSegs = function (e, t) {
                ...
                for (n = 0; n < t.length; n += 1)
                    if ((r = on(s, t[n])) && ((o = { component: this, eventRange: e, start: r.start, end: r.end, isStart: e.isStart && r.start.valueOf() === s.start.valueOf(), isEnd: e.isEnd && r.end.valueOf() === s.end.valueOf(), dayIndex: n }), u.push(o), !o.isEnd && !l && n + 1 < t.length && s.end < i.add(t[n + 1].start, a))) {
